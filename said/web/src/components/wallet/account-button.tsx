...
export function AccountButton() {
  ...
  if (!isConnected || !address) {
    // No "CONNECT WALLET" button blaring on load — this just quietly sits in
    // the corner and only matters once someone tries to do something that
    // needs a wallet, at which point the connect sheet takes over.
    return <span className="text-xs text-ink-faint-2">not connected</span>;
  }
